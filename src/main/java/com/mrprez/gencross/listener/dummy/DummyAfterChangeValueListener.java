...
public class DummyAfterChangeValueListener extends AfterChangeValueListener {
	private Map<String, String> args = new HashMap<String, String>();
	private String className;
	
	
	public DummyAfterChangeValueListener(){
		super();
	}
	
	public DummyAfterChangeValueListener(Element listenerEl, Personnage personnage) {
		super();
