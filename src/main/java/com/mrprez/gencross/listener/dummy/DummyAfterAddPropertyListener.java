...
public class DummyAfterAddPropertyListener extends AfterAddPropertyListener {
	private Map<String, String> args = new HashMap<String, String>();
	private String className;
	
	
	public DummyAfterAddPropertyListener(){
		super();
	}
	
	public DummyAfterAddPropertyListener(Element listenerEl, Personnage personnage) {
		super();
