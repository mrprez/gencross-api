...
public class DummyBeforeDeletePropertyListener extends BeforeDeletePropertyListener {
	private Map<String, String> args = new HashMap<String, String>();
	private String className;
	
	
	public DummyBeforeDeletePropertyListener(){
		super();
	}
	
	public DummyBeforeDeletePropertyListener(Element listenerEl, Personnage personnage) {
		super();
